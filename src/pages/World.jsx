...
export default function World({ setPage }) {
  ...
  const handleRoomAction = (action) => {
    switch (action) {
      ...
      case 'faith': setPage('bible'); break
      case 'surprise':
        // Trigger surprise
        break
      default:
    ...
    >
      ...
      {activeRoom && !roomTransitioning && (
        <div className="fixed inset-0 z-30 flex items-center justify-center bg-midnight/80 backdrop-blur-sm">
          <div className="bg-deep-blue border-3 border-warm-gold/40 shadow-[4px_4px_0_0_#d4a853] p-8 max-w-sm w-full mx-4 text-center">
            ...
            <p className="text-sm text-soft-white/50 mb-6">
              ...
              {activeRoom.id === 'faith' && 'baca Alkitab bareng ☦️'}
